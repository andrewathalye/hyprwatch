package Hyprland is
   ...
   --  Enumerations  --
   --------------------
   type Hypr1_Message_Id is (Dispatch, Keyword, Reload, Kill, Setcursor, Output, Switchxkblayout, Seterror, Setprop, Notify, Dismissnotify, Version, Monitors, Workspaces, Activeworkspace, Workspacerules, Clients, Devices, Decorations, Binds, Activewindow, Layers, Splash, Getoption, Cursorpos, Animations, Instances, Layouts, Configerrors, Rollinglog, Locked);
   ...
   type Hypr2_Message_Id is
     (Workspace, Workspacev2, Focusedmon, Activewindow, Activewindowv2,
      ...
      Destroyworkspacev2, Movetoworkspace, Movetoworkspacev2,
